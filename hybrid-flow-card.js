...
class HybridFlowCard extends HTMLElement {
    ...
    <div id="hfcCard" style="background:#161b22;border:1px solid #21262d;border-radius:0 0 12px 12px;border-top:none;padding:0 13px 13px 13px;box-shadow:0 4px 20px rgba(0,0,0,.4);width:100%;box-sizing:border-box;transition:box-shadow 1s ease;position:relative;overflow:hidden;">
      <div style="width:100%;${this.config.full_width ? '' : 'max-width:520px;'}margin:0 auto;" role="group" aria-label="Hybrid energy flow">
        <div id="headerBar" style="position:relative;width:100%;height:48px;margin-bottom:0;">
          ...
          <div id="solarRadBar" style="display:none;position:absolute;left:0;top:30px;font-size:1.1rem;font-weight:700;color:#f4d03f;letter-spacing:0.2px;line-height:1;">
            ☀️ <span id="solarRadVal">-- W/m²</span>
          </div>
          <div id="rainfallBar" style="display:none;position:absolute;right:0;top:30px;font-size:1.1rem;font-weight:700;color:#58a6ff;letter-spacing:0.2px;line-height:1;">
  ...
  _updateDynamic() {
    ...
    const solarRadBar = this._el('solarRadBar');
    ...
    if (solarRadBar && solarRadVal) {
      ...
      if (showRad) {
        ...
        // Colour: grey at night/0, yellow-to-white as irradiance rises
        solarRadVal.style.color = (rad === undefined || rad < 5) ? '#8b949e'
          : rad < 200 ? '#f4d03f'
          : rad < 600 ? '#f9a825'
          : '#fffde7';
      }
